...
module.exports = {
	...
	createrawtransaction: function(txid,address,amount, callback){
		...
		*/
		//console.log('createrawtransaction::address: ' + address);
	...
	sendrawtransaction: function(rawtransaction, callback){
		/*
		console.log('Sending transaction: placeholder transaction');
		callback('placeholder confirmation message');
		*/
