module.exports = {
	...
	replace: function(borrower,principal,interest,numPayments,monthlyPayments,beginning,id){
		...
		fs.readFile('/Users/stewart/Documents/My\ Work/1\)\ ICL/\*BitCoin/App/FundFlow/lib/hash.txt', 'utf8', function (err,data) {
		  if (err) {
		  ...
		  console.log('Step 9.0. Server. Creating contract, with RIPEMD160 digest ' + ripemd + 'for loan number ' + id);
		  ...
		  fs.writeFile('/Users/stewart/Documents/My\ Work/1\)\ ICL/\*BitCoin/App/FundFlow/lib/contracts/LegalContract' + id +'.txt', result, 'utf8', function (err) {
